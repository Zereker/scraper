...
func TestGetProfile(t *testing.T) {
	...
	cmpOptions := cmp.Options{
		cmpopts.IgnoreFields(twitter2.Profile{}, "FollowersCount"),
		cmpopts.IgnoreFields(twitter2.Profile{}, "FollowingCount"),
		cmpopts.IgnoreFields(twitter2.Profile{}, "FriendsCount"),
		cmpopts.IgnoreFields(twitter2.Profile{}, "LikesCount"),
		cmpopts.IgnoreFields(twitter2.Profile{}, "ListedCount"),
		cmpopts.IgnoreFields(twitter2.Profile{}, "TweetsCount"),
	}
