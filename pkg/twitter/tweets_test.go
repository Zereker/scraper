...
import (
	"context"
	twitter2 "github.com/Zereker/scraper/pkg/twitter"
	"testing"
	"time"
...
var cmpOptions = cmp.Options{
	cmpopts.IgnoreFields(twitter2.Tweet{}, "Likes"),
	cmpopts.IgnoreFields(twitter2.Tweet{}, "Replies"),
	cmpopts.IgnoreFields(twitter2.Tweet{}, "Retweets"),
}
...
func assertGetTweet(t *testing.T, expectedTweet *twitter2.Tweet) {
...
func TestGetTweetWithPhotoAndGIF(t *testing.T) {
	...
	expectedTweet := twitter2.Tweet{
		...
		Photos:       []twitter2.Photo{{ID: "1580661428326907904", URL: "https://pbs.twimg.com/media/Fe-jMcGWQAAFWoG.jpg"}},
